...
binary_info_info_df = json_normalize(parsed_json[0]['entityInfo']['vulnerabilities'])[['packageName','packageVersion','cve','severity','cvss']]
#binary_info_info_df = binary_info_df.loc[binary_info_info_df['cveCount'] > 0 ]
...
#print(list(binary_info_info_df.columns.values))
#print(binary_info_info_df.to_string(index=False))
print(tabulate(binary_info_info_df, headers = 'keys', tablefmt = 'psql'))
